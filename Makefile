...
FILES=main.cpp facedetect.cpp featuredetect.cpp gazeestimate.cpp support.cpp gui.cpp
OBJECTS=support.o gazeestimate.o featuredetect.o facedetect.o gui.o main.o
PROGRAM=gios
